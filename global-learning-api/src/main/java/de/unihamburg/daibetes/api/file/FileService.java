...
public interface FileService {
    ...
    Response deleteFile(@PathParam("fileId") Long fileId, @QueryParam("secret") String secret);
    ...
    FileDTO renameFile(@PathParam("id") Long fileId, FileRenameDTO fileRenameDTO, @QueryParam("secret") String secret);
